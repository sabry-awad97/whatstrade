  ...
  const columns = useMemo<ColumnDef<RequestResponse>[]>(
    () => [
      ...
      },
      {
        ...
        cell: ({ getValue }) => {
          const maxPrice = getValue<string | null>();
          return (
            <span className="tabular-nums">
              {maxPrice != null ? `EGP ${maxPrice}` : "—"}
            </span>
          );
        },
        meta: {
      ...
      <div className="flex-1 overflow-auto flex flex-col">
        ...
        <Empty className="flex-1">
          <EmptyHeader>
            ...
            <EmptyDescription>
              Try adjusting your search or filter criteria to find requests.
            </EmptyDescription>
          </EmptyHeader>
        </Empty>
      </div>
